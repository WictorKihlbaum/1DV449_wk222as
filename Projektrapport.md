...
<b>1.</b> Användare kan navigera på hela webbsidan när de är offline. <br />
<b>2.</b> Resurser kommer direkt från den lokala datorn. Ingen nätverksrutt krävs. <br />
<b>3.</b> I det fall min sida stängs ned på grund av exempelvis underhåll så kommer mina besökare få offline-upplevelsen [8].</p>

<p>I det fall applikationen går offline kommer den vara cachad tills något av följande sker:<br />
<b>1.</b> Användaren rensar webbläsarens 'datastorage' för min sida.<br />
<b>2.</b> Manifest-filen modifieras [8].</p>
...
<p>En sak jag haft i åtanke under hela utvecklingensprocessen är att ständigt bibehålla besökaren i fokus. Jag har arbetat för att min applikation ska resultera i såpass användarvänlig upplevelse som möjligt. Det finns informationsruter för användaren på såväl sidan för lokal redigering som sidan för redigering av Google Drive-bilder. På var och en av dessa sidor presenteras det även felmeddelanden för användaren i det fall denne gör något fel alternativt något tekniskt gick fel. På sidan för listning Google Drive-bilder presenteras även ett "success"-meddelande för användaren vid varje lyckad uppladdning till Google Drive.</p>

...
<p><b>2.</b>Utöver grundkravet på att implementera två API:er att hämta data ifrån, har jag även implementerat ett flertal andra API:er av varierande storlek och typ. I syfte att ladda in en användares bild vid lokal bildredigering använder jag mig av det HTML5-implementerade FileReader API:et. Vid förhandsgranskning av de hämtade bilderna från Google Drive tar jag till hjälp av Fullscreen API. Även detta API är implementerat i HTML5.</p>
